...
class CameraBridge extends EventEmitter {
  ...
  start() {
    ...
    child.stdio[4].on('data', chunk => this.overlaySnapshots.push(chunk));
  ...
  /** Raw D435 RGB stream reserved for read-only calibration capture. */
...
module.exports = { CameraBridge, OverlaySnapshotAssembler };
