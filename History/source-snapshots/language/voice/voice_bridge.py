...
def build_model_manager(args: argparse.Namespace) -> Any:
    ...
    whisper_path = model_root / "whisper-small"
    nano_path = model_root / "fun-asr-nano"
    paraformer_path = model_root / "paraformer-streaming"
    return ModelManager({
        "whisper-small": lambda: WhisperSmallBackend(str(whisper_path)),
        "fun-asr-nano": lambda: FunASRNanoBackend(str(nano_path)),
