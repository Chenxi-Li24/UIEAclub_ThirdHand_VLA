...
```bash
git add PinZiZhuaQuSkill/src/thirdhand_va/vision/preview PinZiZhuaQuSkill/tests/vision/preview/test_source.py
...
```bash
git add PinZiZhuaQuSkill/src/thirdhand_va/vision/visualization PinZiZhuaQuSkill/tests/vision/visualization
...
```bash
git add PinZiZhuaQuSkill/src/thirdhand_va/vision/preview PinZiZhuaQuSkill/tests/vision/preview/test_service.py
...
```bash
git add PinZiZhuaQuSkill/src/thirdhand_va/vision/preview PinZiZhuaQuSkill/tests/vision/preview/test_server.py
...
```bash
git add PinZiZhuaQuSkill/apps/vision_preview PinZiZhuaQuSkill/tests/integration/test_vision_preview_entrypoint.py
...
```bash
git add PinZiZhuaQuSkill/.vscode PinZiZhuaQuSkill/scripts/vision/preview_smoke.py PinZiZhuaQuSkill/docs/vision PinZiZhuaQuSkill/README.md PinZiZhuaQuSkill/tests/integration/test_preview_debug_assets.py
...
```bash
git add PinZiZhuaQuSkill/tests/hardware/test_live_vision_preview.py
