...
```bash
git add PinZiZhuaQuSkill/src/thirdhand_va/vision/preview/fused_source.py PinZiZhuaQuSkill/src/thirdhand_va/vision/preview/__init__.py PinZiZhuaQuSkill/tests/vision/preview/test_fused_source.py
...
```bash
git add PinZiZhuaQuSkill/src/thirdhand_va/vision/preview/server.py PinZiZhuaQuSkill/src/thirdhand_va/vision/preview/__init__.py PinZiZhuaQuSkill/tests/vision/preview/test_server.py
...
```bash
git add PinZiZhuaQuSkill/apps/vision_lan PinZiZhuaQuSkill/tests/integration/test_vision_lan_entrypoint.py PinZiZhuaQuSkill/.vscode/launch.json
...
```bash
git add PinZiZhuaQuSkill/docs/vision/preview.md PinZiZhuaQuSkill/README.md PinZiZhuaQuSkill/tests/integration/test_preview_debug_assets.py PinZiZhuaQuSkill/docs/superpowers/plans/2026-08-23-lan-rgbd-viewer.md
