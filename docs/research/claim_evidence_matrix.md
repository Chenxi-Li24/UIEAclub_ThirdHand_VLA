...
from a preregistration before a run begins. Until that information is supplied, these
examples remain `Evidence Incomplete / 待补充证据`; do not infer a threshold from a
benchmark reference or use the row as a result.
