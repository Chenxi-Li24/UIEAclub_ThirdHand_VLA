...
- [ ] **Step 3: Copy and constrain the bridge**
...
- Vision HTTP paths proxy to `127.0.0.1:3100` and return explicit 503 when unavailable.
...
**Files:**
- Create: `assets/robot/startouch-v3/**`
...
- [ ] **Step 1: Write failing profile and asset tests**

Assert both profiles use formal entrypoints, Robot remains loopback-only, simulation sets `STARTOUCH_SIMULATE=1`, model URDF exists, and default does not silently enable hardware.

- [ ] **Step 2: Verify RED**

Run platform and integration tests; expect missing profiles/assets.

- [ ] **Step 3: Copy model assets and add profiles**
